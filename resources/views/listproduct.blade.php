    ...
    <div class="site-navbar bg-white py-2 position-relative">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="{{url("/")}}" class="js-logo-clone">Mun Mun Shop</a>
            </div>
          </div>
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li class="has-children active">
                  <a href="home.blade.php">Collection</a>
                  <ul class="dropdown">
                    <li><a href="#">Men</a></li>
  ...
  <div class="container-fluid">
    <div class="row no-gutters products">
      ...
      <div class="col-6 col-md-6 col-lg-6 border-top">
        <a href="{{url("/product/{$l->id}")}}" class="item">
          ...
          <div class="item-info">
            ...
            <strong class="price">{{$l->price}}</strong>
          </div>
        </a>
      </div>
        @endforeach
